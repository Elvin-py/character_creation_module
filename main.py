...
class Character:
    # Константа для диапазона очков урона (переменный класса Character)
    ...
    def attack(self):
        ...
        print(f'{self.name} нанёс противнику урон, равный '
              f'{value_attack}')

    def defence(self):
        defence_value = DEFAULT_DEFENCE + randint(*self.RANGE_VALUE_DEFENCE)
        print(f'{self.name} блокировал {defence_value} ед. урона')
